...
from core.model import HiddenPopVariationalMF
...
def main(params):
    ...
    model = HiddenPopVariationalMF(
        ...
        sigma_trainable=params['sigma_trainable']
    )
    # prob = 0.0053
...
if __name__ == "__main__":
    ...
    params['model_name'] = 'HiddenVI-global' if params['global_pop'] else 'HiddenVI-local'
